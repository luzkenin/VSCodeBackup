#
# Module manifest for module 'VSCodeBackup'
#
...
@{
    ...
    Description       = 'Simple module to backup VS Code extensions and settings. Useful for transferring to an offline network.'
